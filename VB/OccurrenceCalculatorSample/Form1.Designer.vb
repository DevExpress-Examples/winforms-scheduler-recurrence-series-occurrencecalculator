Namespace OccurrenceCalculatorSample
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.schedulerControl1.Size = New System.Drawing.Size(784, 420)
			Me.schedulerControl1.Start = New Date(2015, 12, 29, 0, 0, 0, 0)
			...
			' btnTest
			' 
			Me.btnTest.Caption = "RecurrentSeries->NormalSeries"
			Me.btnTest.Id = 43
			Me.btnTest.Name = "btnTest"
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnTest.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.btnTest_ItemClick);
			' 
			' Form1
			' 
		...
		Private WithEvents btnTest As DevExpress.XtraBars.BarButtonItem
	End Class
End Namespace
